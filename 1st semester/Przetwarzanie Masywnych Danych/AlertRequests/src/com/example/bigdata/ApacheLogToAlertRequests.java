...
public class ApacheLogToAlertRequests {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KTable<Windowed<String>, Long> ipCounts = apacheLogStream
                ...
                .groupByKey()
                .windowedBy(TimeWindows.of(Duration.ofMillis(10)) /* time-based window */)
                .count();
        ...
        KTable<String, String> difficultIps = ipCounts.toStream()
                ...
                .groupByKey()
                .reduce((aggValue, newValue) -> newValue, Materialized.<String, String, KeyValueStore<Bytes, byte[]>>as("DifficultIpsStore"));
